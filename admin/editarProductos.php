...
if (isset($_REQUEST['guardarP'])) {
    ...
    if (!empty($_FILES['imagenE']['tmp_name'])) {
        ...
        $query = "UPDATE productos SET
            ...
            fecha_lanzamiento='  $fecha_lanzamiento  ', clasificacion='  $clasificacion  ',estado=' $estado ', imagen=' $imagen '
            where id='  $id ' ;
        ";
    } else {
        $query = "UPDATE productos SET
    ...
    <div class="container">
        <form method="POST">
            ...
            <div class="form-group mb-3">
                ...
                <input type="text" class="form-control" name="estado" value="<?php echo $row['estado'] ?>" required="required">
            </div>
            <div class="form-group mb-3">
